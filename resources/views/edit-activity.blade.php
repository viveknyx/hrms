    ...
    <div class="card bg-light-info shadow-none position-relative overflow-hidden">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8" style="font-size: 30px">Edit Activity</h4>
            ...
            <div class="card-body border-top">
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <div class="mb-3">
                            <label for="inputcom" class="control-label col-form-label">Edit Title</label>
                            <input name="edittitle" class="form-control" id="inputcom" placeholder="Edit title" />
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="mb-3">
                            <label class="control-label col-form-label">Edit Start Date</label>
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="mb-3">
                            <label class="control-label col-form-label">Edit End Date</label>
                            <div class="form-group">
