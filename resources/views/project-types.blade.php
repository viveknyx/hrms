    ...
    <div class="card bg-light-info shadow-none position-relative overflow-hidden">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8" style="font-size: 30px">Types</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Types</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-3">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="zero_config" class="table border table-bordered text-nowrap">
                            ...
                            <tbody>
                                @php
                                    $projects = DB::table('project_types')->get();
                                    $count = 1;
                                @endphp
                                        ...
                                        <td>
                                            <div class="btn-group mb-2">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><span class="dropdown-item" onclick="onEditClick({{$project->id}}, '{{ $project->name }}')">Edit</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="zero_config" class="table border table-bordered text-nowrap">
                            ...
                            <tbody>
                                <tr>
                                    <form action="{{ route('add.project.type') }}" method="post">
                                        @csrf
                                        <div class="mb-3">
                                            <label for="inputcom" class="control-label col-form-label">Add New
                                                Type</label>

                                            <input class="form-control" name="addProjectTypeField" id="inputcom"
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="zero_config" class="table border table-bordered text-nowrap">
                            ...
                            <tbody>
                                <tr>
                                    <form action="{{ route('edit.project.type') }}" method="post">
                                        @csrf
                                        <div class="mb-3">
                                            <label for="namecom" class="control-label col-form-label">Edit Type</label>
                                            <input id="idcom" name="idcom" type="hidden">
                                            <input class="form-control" id="namecom" name="namecom" placeholder="Edit Type Name" />
                                        </div>
                                        <button class="btn btn-info rounded-pill px-4 waves-effect waves-light"
