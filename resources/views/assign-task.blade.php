<x-app-layout>
    <div class="card bg-light-info shadow-none position-relative overflow-hidden">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8" style="font-size: 30px">Assign Task</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Assign Task</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-3">
    ...
    <div class="card w-100">
        <form action="{{ route('assign.task.db') }}" method="post">
            @csrf
            <div class="card-body border-top">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="mb-3">
                            <div class="mb-3">
                                <label for="inputcom" class="control-label col-form-label">Task Name</label>
                                <input name="taskName" class="form-control" id="inputcom"
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 mb-3">
                        ...
                        <div class="gap-2" style="display: flex; justify-content: center; align-items: center">
                            <select class="select2 form-control" name="groups[]" id="select2-language"
                                multiple="multiple">
                                @php
